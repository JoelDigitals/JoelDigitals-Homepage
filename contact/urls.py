...
urlpatterns = [
    ...
    path('admin-tickets/archive/', views.ticket_archive_view, name='archive_ticket'),
    path('admin-tickets/archive/<str:ticket_number>/', views.ticket_detail_view, name='admin_ticket_detail'),
    ...
    path('api/available-dates/', views.get_available_dates, name='api_available_dates'),
